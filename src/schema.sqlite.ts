...
import { users } from "drizzle-graphql-rbac/tables/sqlite";

export { roles, users, sessions, frameworkTables } from "drizzle-graphql-rbac/tables/sqlite";
export type { Role, NewRole, User, NewUser, Session } from "drizzle-graphql-rbac/tables/sqlite";
